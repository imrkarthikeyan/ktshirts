        ...
        <main className={isDark ? "min-h-screen bg-zinc-950 text-zinc-100" : "min-h-screen bg-zinc-50 text-zinc-900"}>
            ...
            <section className="mx-auto max-w-7xl px-4 pt-12 md:pt-16">
                <div className="fade-up mx-auto max-w-3xl text-center">
                    ...
                    <h1 className="mt-4 text-5xl font-semibold tracking-wide md:text-7xl font-[Cormorant_Garamond]">Kids Wears</h1>
                        ...
                        {filteredProducts.map((product, index) => (
                            ...
                            >
                                <button
                                    ...
                                    className={`wishlist-heart-btn absolute right-3 top-3 z-20 ${isWishlisted(product.id, "kids") ? "wishlist-heart-active" : ""}`}
