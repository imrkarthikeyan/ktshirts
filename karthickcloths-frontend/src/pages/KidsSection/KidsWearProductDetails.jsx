...
function KidsWearProductDetails({ isDark }) {
    ...
    useEffect(() => {
        const loadProduct = () => {
            const fallbackProduct = getCatalogProductById("kids", productId) || kidsProductsFallback.find((item) => item.id === productId);
                ...
                <div className="mt-6 grid gap-8 md:grid-cols-2 xl:grid-cols-[1.1fr_1fr]">
                    ...
                    <div className="slide-in-right">
                        ...
                        <div className="mt-2 flex items-start justify-between gap-3">
                            ...
                            >
                                <WishlistHeartIcon active={isWishlisted(product.id, "kids")} className="h-5 w-5" />
                            </button>
                        </div>
